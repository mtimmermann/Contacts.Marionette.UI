define(function(require, exports, module) {
    ...
    return Backbone.Paginator.clientPager.extend({
		...
		getCollection: function() {
            // Ensure Backbone pagination this origModels is
            //  defined, set reset to true
        ...
        _generateStubbedData: function() {
            ...
            //         _this.deferred.resolve(response);
            //     })
            //     .fail(function () {
            //         _this.deferred.resolve(_this._stubbedData());
            //     });
            // $.when(this.deferred.promise).done(function() {
            //     //_this.models = _this._stubbedData();
            //     _this.reset(_this._stubbedData());
            // });
            this.deferred = new $.Deferred();
